            ...
            <div className="bg-white w-[64rem] h-[50rem] rounded-3xl mb-10 ml-52">
                ...
                <div className="flex flex-nowrap flex-col items-center mb-6">
                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        ...
                        <DisplayText label={"Username"} text={user.username} color="b3"/>
                    ...
                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        ...
                        <div className="columns-2">
                            <DisplayText label={"First Name"} text={user.firstName} color="b3"/>
                            <DisplayText label={"Last Name"} text={user.lastName} color="b3"/>

                            <DisplayText label={"Email"} text={user.email} color="b3"/>
                    ...
                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        ...
                        <DisplayText label={"Arpeggio User ID"} text={user.id.toString()} color="b3"/>
                        <DisplayText label={"MetaMask Address"} text={user.mmAddr} color="b3"/>
                    </div>
                </div>
            </div>
