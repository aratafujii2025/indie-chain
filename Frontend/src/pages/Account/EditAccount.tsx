...
function DisplayInput(props: diProps) {
    ...
    if(label === "Arpeggio User ID" || label === "MetaMask Address" || label === "Phone"){
        return(
            <div className="mb-2">
                <div className="inline-block pl-4 pr-8 text-silver-dark">
                    {label}
                </div>
                <div className="inline-block text-silver-dark pl-2">
                    {defaultVal}
                </div>
            </div>
        )   
    ...
    return (
        <div className="bg-cream w-full h-full overflow-auto flex flex-nowrap flex-col">
            ...
            <div className="bg-white w-[64rem] h-[50rem] rounded-3xl mb-10 ml-52">
                ...
                <button onClick={navAcc} type="submit" className="inline-block w-7 h-7 ml-[17rem] -mb-2 opacity-50"> 
                    Save
                </button>
                ...
                <div className="flex flex-nowrap flex-col items-center mb-6">
                    ...
                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        ...
                        <div className="columns-2">
                            ...
                            <DisplayInput label={"Phone"} type="" defaultVal="Coming Soon!"/>
                        </div>
                    </div>

                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        <h4 className="italic font-semibold mb-4 text-silver-dark">Details</h4>
                        <DisplayInput label={"Arpeggio User ID"} type="" defaultVal="0123"/>
                        <DisplayInput label={"MetaMask Address"} type="" defaultVal="0xa12b3 . . . qp9q6"/>
                    </div>
                </div>
            </div>
