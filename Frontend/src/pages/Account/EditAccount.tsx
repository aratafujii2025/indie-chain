        ...
        <div>
            <div className="bg-cream w-full h-full overflow-auto flex flex-nowrap flex-col z-0 absolute">
                ...
                <div className="bg-white w-[64rem] h-[50rem] rounded-3xl mb-10 ml-52">
                    ...
                    <button type="submit" className="inline-block w-7 h-7 ml-[17rem] -mb-2 opacity-50"> 
                        Save
                    </button>
                    ...
                    <div className="flex flex-nowrap flex-col items-center mb-6">
                        <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                            ...
                            <DisplayInput label={"Username"} labelColor="silver-dark" type="text" defaultVal="lizgran28"/>
                        ...
                        <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                            ...
                            <div className="columns-2">
                                <DisplayText label={"First Name"} text="Elizabeth" color="silver-dark"/>
                                <DisplayText label={"Last Name"} text="Grant" color="silver-dark"/>

                                <DisplayInput label={"Email"} labelColor="silver-dark" type="email" defaultVal="elizabeth.grant@gmail.com"/>
                        ...
                        <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                            ...
                            <DisplayText label={"Arpeggio User ID"} text="0123" color="silver-dark"/>
                            <DisplayText label={"MetaMask Address"} text="0xa12b3 . . . qp9q6" color="silver-dark"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className={verifyClass}>
                <Verify visible={false} setVisible={setVerifyVis} setNext={setOtcVis}/>
            </div>
            ...
            <div className={pwClass}>
                <ChangePw visible={false} setVisible={setChangePw} username="fetch username with axios"/> 
            </div>
        </div>
