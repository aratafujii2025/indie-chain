...
// make custom phone number input component
// left as string for now

function DisplayInput(props: diProps) {
    const {label, defaultVal, type} = props;

    
    if(label === "Arpeggio User ID"){
        return(
            <div className="mb-2">
                <div className="inline-block pl-4 pr-8 text-silver-dark">
                    {label}
                </div>
                <div className="inline-block text-silver-dark">
                    {defaultVal}
                </div>
            </div>
        )   
    }else if(label === "MetaMask Address"){
        return(
            <div className="mb-2">
                <div className="inline-block pl-4 pr-8 text-silver-dark">
                    {label}
        ...
        */
        ...
        return(
            <div className="mb-2">
                ...
                <div className="inline-block text-b3 pl-2">
                    {defaultVal}
                </div>
            </div>
        ) 
    ...
    return(
        <div className="mb-2">
            <label className="inline-block pl-4 pr-8 text-silver-dark">
                {label}
            </label>
            <input type={type} defaultValue={defaultVal} className="inline-block text-b3 focus:outline-silver-light outline-1 pl-2 rounded-full pr-2"/>
        </div>
    )
}
...
function EditAccount() {
    const[bgDim, setBgDim] = React.useState(false);
        ...
        <div className="bg-cream w-full h-full overflow-auto flex flex-nowrap flex-col">
            ...
            <div className="bg-white w-[64rem] h-[50rem] rounded-3xl mb-10 ml-52">
                ...
                <div className="inline-block pt-6 pb-1 px-6">
                    <div>
                        <img 
                            className="w-36 h-36 rounded-full z-0 relative"
                    ...
                    <div className="bg-silver-dark bg-opacity-50 w-36 h-36 rounded-full absolute z-10 -mt-[9rem]"/>
                    <div className="absolute z-20 -mt-[5.25rem] ml-[3.75rem]">
                ...
                <div className="flex flex-nowrap flex-col items-center mb-6">
                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        ...
                        <DisplayInput label={"Username"} type="text" defaultVal="lizgran28"/>
                        <DisplayInput label={"Password"} type="password" defaultVal="••••••••••••••••"/>
                    </div>
                    ...
                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        ...
                        <div className="columns-2">
                            <DisplayInput label={"First Name"} type="text" defaultVal="Elizabeth"/>
                            <DisplayInput label={"Last Name"} type="text" defaultVal="Grant"/>

                            <DisplayInput label={"Email"} type="email" defaultVal="elizabeth.grant@gmail.com"/>
                            <DisplayInput label={"Phone"} type="text" defaultVal="+00 12 34 56 78 99"/>
                        </div>
                    </div>

                    <div className="py-4 px-6 mb-2 w-[50rem] h-36 mt-2 rounded-3xl border-2 border-silver-light">
                        <h4 className="italic font-semibold mb-4 text-silver-dark">Details</h4>
                        <DisplayInput label={"Arpeggio User ID"} type="text" defaultVal="0123"/>
                        <DisplayInput label={"MetaMask Address"} type="text" defaultVal="0xa12b3 . . . qp9q6"/>
                    </div>
                </div>
            </div>
