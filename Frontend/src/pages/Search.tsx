...
function Search() {
    ...
    const menuOptions = [
        {id: "new", display: "Newest"},
        {id: "popular", display: "Most Popular"}, 
        {id: "alph", display: "Alphabetical"},
        {id: "cardsAsc", display: "Cards Available 🡑"},
        {id: "cardsDesc", display: "Cards Available 🡓"}
    ];
    ...
    getArtists();
//bg-gradient-to-r from-white border-white
    return (
